...
public class TypeDataMap {
    public static final String NUMERIC_DATA_UTI = "com.physion.ovation.numeric-data";
    ...
    public static class TypeData {
        ...
        public String toString()            { return "uti:" + _uti + ", mime:" + _mimeType + ", ext:" + _extensions; }
    }
    ...
    static {
        ...
        _addType(new TypeData("public.jpeg",                "image/jpeg",               ".jfif", ".jfif-tbnl", ".jpe", ".jpeg", ".jpg"));
